...
from adminpanel.models import SubscribeUser,Logo,Footerlinks,Cms,Faq,UserWithroles,UserProfile,Category,ProductReview,FavouriteProducts,ProductDetails,PostJobInterest,ProductCategory
