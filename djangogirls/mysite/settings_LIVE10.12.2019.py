...
UPLOAD_URL_ROOT = 'http://138.197.3.122:8009/static/upload/'

UPLOAD_URL_CSV = os.path.join(STATIC_ROOT,'media/all_excel')
UPLOAD_URL_ROOT_CSV = 'http://138.197.3.122:8009/static/media/all_excel'
#STATICFILES_DIRS = (
#    ('', os.path.join(BASE_DIR,'static')), #store site-specific media here.
#)
PATH_URL = 'http://138.197.3.122/inteerApp/#'
PYTHON_URL = 'http://138.197.3.122:8009/'
IMAGE_URL = 'http://138.197.3.122:8009/static/media/'

BASE_URL = 'http://138.197.3.122:8009'
...
# 0  of STRIPE_PLAN_ID_DICT --> PREMIUM
# 1 of STRIPE_PLAN_ID_DICT  --> BASIC
# 2 of STRIPE_PLAN_ID_DICT  --> ENTERPRISE

################################ STRIPE SETTINGS ########################################

################################ CRON TAB ###############################################
CRONJOBS = [
    ('*/1 * * * *', 'adminpanel.cron.my_scheduled_job','>> /var/www/html/inteer/adminpanel/file.log')
]
